...
Seems like I needed to update the user model and fix some things I had done earlier. I am keeping two fields now for the name. One will be the username that Discord provides, and the other will be the name that the user wants to be displayed on the site. I think that makes more sense otherwise w